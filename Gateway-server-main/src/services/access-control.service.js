 ...
 * @description Сервіс семантичного контролю доступу (RBAC).
 * Реалізує Матрицю Контролю Доступу, перевіряє рольові ліміти (5 балів для студентів, 20 для викладачів)
 * та блокує спроби зміни недозволених сутностей.
 */

/**
 * Перевіряє права доступу користувача до виконання конкретної операції.
 *
 * @param {Object} params - Параметри перевірки (parsed, templateInfo, userContext).
 * @returns {{ok: boolean, errors: string[]}} Результат перевірки прав доступу.
 */
