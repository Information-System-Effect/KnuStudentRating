/**
 * @module TemplateDetectorService
 * @description Сервіс контекстного аналізу. Визначає логічний шаблон запиту 
 * (наприклад, "rating" або "general") на основі цільових полів та методів.
 */

/**
 * Класифікує запит за бізнес-типом взаємодії.
 *
 * @param {Object} parsed - Об'єкт запиту.
 * @returns {string} Тип шаблону: "rating" (оцінювання) або "general" (загальні запити).
 */
