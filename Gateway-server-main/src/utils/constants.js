/**
 * @module Constants
 * @description Глобальні константи системи «ІС ефект шлюз».
 * Містить списки дозволених операцій, рейтингові категорії (софт-скіли та технічні),
 * конфігурацію ролей (STUDENT, TEACHER), ліміти балів та налаштування безпеки.
 */
