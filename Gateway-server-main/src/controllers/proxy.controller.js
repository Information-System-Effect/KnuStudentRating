 ...
 * @description Контролер для обробки звичайного HTTP-трафіку (Reverse Proxy).
 * Перехоплює запити, що не стосуються текстового протоколу шлюзу, і пересилає їх на бекенд.
 */
